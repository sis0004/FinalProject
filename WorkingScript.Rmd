...
### Parse data into smaller data tables that are easier to read and search in
```{r}
...
### Loop / function? that creates scatter plots for any element input
...
ex: a straight (ish) line might indicate that the occurance of that element might be controlled by pH
    helps answer the research question: How does pH affect water chemistry?
